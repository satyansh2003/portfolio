...
export const TimeLineData = [
  { year: 2022, text: 'Started with my graduation at Chitkara University', },
  { year: 2023, text: 'Got hands on languages like Python, C and C++ and basics of Web Dev', },
  { year: 2024, text: 'Began developing full-stack projects while simultaneously refining my data structures and algorithms (DSA) skills in C++. Later, I transitioned to Java.', },
  { year: 2025, text: 'Exploring new technologies like 3JS, WEB3 and blockchian', },
];