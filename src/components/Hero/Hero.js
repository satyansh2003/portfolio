...
const Hero = () => (
  <Section row nopadding>
    <LeftSection>
      ...
      <SectionText>
      Passionate about crafting innovative digital experiences, I am a Computer Science and Engineering student with a keen interest in web development, software engineering, and problem-solving. From building modern web applications to working on interdisciplinary projects, I thrive on creating impactful solutions. Explore my portfolio to discover my journey, projects, and skills that reflect my commitment to technology and continuous learning.
      </SectionText>
